...
export function ReservationCard({
  ...
  return (
    <div className="w-full md:w-[448px] h-auto md:min-h-64 bg-[#FAFAFA] border-2 border-border/30 rounded-lg overflow-hidden flex flex-col md:flex-row md:items-center md:pr-6">
      ...
      <div className="flex flex-col items-start justify-center gap-4 w-full p-4 md:py-2 md:pl-6">
